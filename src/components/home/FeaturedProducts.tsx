  ...
  return <section className="py-24 bg-ice-50">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {products.map(product => <Card key={product.id} className="overflow-hidden bg-white hover:shadow-xl transition-shadow duration-300 border-none relative">
              {product.featured && <div className="absolute top-4 right-4 z-10">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <Button className="bg-ice-600 hover:bg-ice-700 text-white flex items-center" onClick={() => handleDownload(product.name, product.sheet)}>
